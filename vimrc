...
set tabstop=2     " Number of spaces a Tab character in a file counts for
set softtabstop=2 " Number of spaces to insert when Tab key is pressed
set shiftwidth=2  " Size of an 'indent' - used by > and < commands
...
" Tab Completion
"================
set wildmode=longest:list,full " Tab completion behavior
